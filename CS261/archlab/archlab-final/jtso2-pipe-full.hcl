#NetID: jtso2
#UIN: 662758603
#Code Description: This is the original code, however, 
#I have added the IIADDQ instruction throughout.
#I included this with a valC and a valB (register)
#I updated the cc to work when this is done as well. Nothing to memory.
#This was similar to our previous hw6.
#/* $begin pipe-all-hcl */
####################################################################
