...
/** @file t11_clone-B.cpp
  two functional tests on clone:
         - clone+push_back+length test: length of source list
         - clone+push_back+length test: length of cloned list
*/
...
int main(int argc, char *argv[]){
  ...
  START("~List::clone test Suite (B) - 4.28  pts"); 
  {
