...
/** @file t3_len-A.cpp
	...
	one runtime test of length function:
	
	- runtime test: long list built using only push_front operations;
		length invoked (expecting O(1) runtime)
...
int main(int argc, char *argv[]){
  ...
  START("~List::length test Suite (A) - 3 pts"); 
