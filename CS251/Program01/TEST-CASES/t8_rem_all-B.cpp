...
/** @file t8_rem_all-B.cpp

        functional tests of fast_remove_all.

	- remove zeros from a lst of (5 1's) (5 0's) (5 1's) (5 0's).	
		Tests return value.
	- after above test make sure list has exactly 10 1's.
*/
...
int main(int argc, char *argv[]){
  ...
  START("~List::fast_remove_all test Suite (B) - 5 points"); 
  {
    int i;
