...
/** @file t5_prefix-A.cpp

	Two related functional tests of the prefix function:

		- zero-length prefix test; checks that prefix
			produced is indeed an empty list.
		- another zero-length perfix test; checks that
			given list (calling object) is unchanged.
...
int main(int argc, char *argv[]){
  ...
  START("~List::prefix test Suite (A) (4 pts)"); 
  {
	int i;
